//
//  MySchedule3ViewController.swift
//  Conference
//
...
class MySchedule3ViewController: UIViewController,IndicatorInfoProvider{
...
extension MySchedule3ViewController: UITableViewDelegate, UITableViewDataSource{
